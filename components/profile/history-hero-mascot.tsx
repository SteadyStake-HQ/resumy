...
export function HistoryHeroMascot() {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={isBubbleVisible ? "Hide mascot message" : "Show mascot message"}
        style={{
          position: "absolute",
          top: 8,
          right: 0,
      ...
      >
        <div
          style={{
            transform: isBubbleVisible ? "translateY(-2px) scale(1.02)" : "translateY(0) scale(1)",
            transition: "transform 280ms cubic-bezier(.22,1.2,.36,1)",
          }}
        >
          <BuniMascot size={120} mood={isBubbleVisible ? "wave" : "idle"} />
        </div>
      </button>
    </div>
  );
